...
public class FinancieraRepository {
	...
	public boolean deleteAllById(Integer id) {
		System.out.println("Invocando a eliminar todas las deudas de un estudiante del area financiera");
		boolean bandera = false;
	...
	private void cargarDeudasFinanciera() {
		...
		FinancieraEntity objFinanciera4 = new FinancieraEntity(3, "Sandra", "Sanchez",150000 ,"Seguro Estudiantil", new Date());
		this.listaDeudasFinanciera.add(objFinanciera4);
